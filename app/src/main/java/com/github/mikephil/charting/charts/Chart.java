...
public abstract class Chart<T extends ChartData<? extends DataSet<? extends Entry>>> extends View
    ...
    protected float mOffsetLeft = 0; // Was previously 12

    /** chart toffset to the top */
    protected float mOffsetTop = 0;// Was previously 12

    /** chart offset to the right */
    protected float mOffsetRight = 0;// Was previously 12

    /** chart offset to the bottom */
    protected float mOffsetBottom = 0;// Was previously 12
